<template>
  <div>
    <div>
      ...
      <form class="space-y-4 md:space-y-6 mt-6" @submit.prevent="addSubCarrier">
        <div>
          <div
...
export default {
  ...
  methods: {
    ...mapActions({
      CreateSubCarrier: "sub-carrier/CreateSubCarrier",
    ...
    async addSubCarrier() {
      try {
        ...
        const response = await this.CreateSubCarrier(this.formData);
        this.$toast.open({
